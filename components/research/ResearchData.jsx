...
const RESEARCH = [
  {
    id: 0,
    company: 'CMU Reliable Autonomous Systems Lab',
    href: 'https://www.ri.cmu.edu/robotics-groups/reliable-autonomous-systems-lab/',
    title: 'Undergraduate Researcher',
    date: 'Jan 2021 -- July 2021',
    bullets: [
      <span>Worked on <InlineLink href = "https://www.cs.cmu.edu/~teachable/personnel.html"> Multi-Modal Communication for Teachable Robots </InlineLink> with Dr. Reid Simmons.</span>,
    ],
  },
  {
    id: 1,
    ...
    bullets: [
      <span>Conducting cutting-edge research in the Machine Learning Department under the guidance of Dr. <InlineLink href="https://www.cs.cmu.edu/~nihars/">Nihar Shah</InlineLink> as an Undergraduate Researcher, focused on automating paper-reviewer assignments for academic journals.</span>,
  ...
  },
  {
    ...
    bullets: [
      <span>Developed an open-source Python package for a novel trial-by-trial, spike-timing-based Bayesian decoding algorithm, revolutionizing the understanding of non-classically responsive neurons’ coding capacities in the brain.</span>,
      ...
      <span>By making the decoding algorithm accessible through an easy-to-use package, contributed to the democratization of neuroscience research, enabling scientists worldwide to investigate neuron responsiveness with greater ease and accuracy. See the package on <InlineLink href="https://github.com/InsanallyLab/DecodingPackage">GitHub</InlineLink>.</span>,
    ],
  },
].reverse();
